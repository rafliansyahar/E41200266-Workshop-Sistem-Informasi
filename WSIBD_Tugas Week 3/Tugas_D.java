...
public class Tugas_D {
	...
	System.out.println("-------------------------------------------------");
	System.out.println("                RAFLI SWALAYAN");
	...
	for (int i=0; i < barang.length; i++) {
        ...
        if (promo==true) {
            ...
            System.out.println("    Anda mendapatkan 1 buah gelas cantik");
        } else {
             System.out.println("Anda tidak mendapatkan promo");
        }
            System.out.println("---------------------------------------------");
            System.out.println("            Terima Kasih");
            System.out.println("    Anda sudah berbelanja di RAFLI SWALAYAN");
        }
    }
